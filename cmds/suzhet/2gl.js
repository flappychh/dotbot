...
const embed = new MessageEmbed()
  .addField("глава вторая.", "```и вот вы очнулись после приземления. первое что вы осознали - у вас появился инвентарь, прямо как в игре!\n~ЕБААААТЬ ЧЕ~\nсразу же подумали вы. теперь, вам конечно же захотелось его увидеть. и о чудо, он появился в эмбеде. вы заметили что у вас в первом слоте книга, та самая, которую вы прихватили с собой по пути в лес...```")
  .setColor("#767f8b")
  ...
  .addField("глава вnjая.", "```вы прочитали вторую главу, спасибо!```")
  .setColor("#767f8b")
